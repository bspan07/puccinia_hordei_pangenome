...
`Figure1_chromatin_contact.R` : plots a bar chart with mean±SE for chromatin contact to constituent nucleus or other nucleus for chromosomes 1-18.
...
**Figure 6**
in `Figure6.R`: pangenome saturation curve; histogram....
